...
<p>The client, Fleeky Curtains, together with the team of developers will create a working ecommerce website that will be used for their customers to make purchases. The Work Breakdown Structure presented here represents all the work required to complete this project. The project will have several activities to collect so that it is polished based on the client’s standard. This will also guide the development on the movement of the output and what are the things that will/have occurred.</p>
