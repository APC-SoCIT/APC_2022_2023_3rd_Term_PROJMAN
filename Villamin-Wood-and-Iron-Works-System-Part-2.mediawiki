...
# The system will have user-friendly instructions and an interface, making it easy to operate and meet all the requirements for the project. </p>
...
===Quality Assurance===
<p> The Agile approach will be used to carry out the quality assurance approach for the Villamin Wood and Iron Works System project. This strategy aims to achieve appropriate implementation through consistent enhancement and teamwork. The following actions will be taken: </p>
# Defining Quality Standards-</b> To make sure that the deliverables meet the project's quality standards, the project team and stakeholders collaborated effectively. </p>

# <b>Quality Auditing</b>- The team, with the collaboration of the stakeholder, will monitor and evaluate the quality of the project deliverables, ensuring adherence to established standards and specifications. The team will report and document findings to maintain records and communication with the stakeholders, Scheduling that will outline the initial plan and meet the deadlines, and continuous improvement to emphasize importance and better output of the project.
# <b>Quality Metrics </b>- The project team will monitor and report on how the project performed regarding the quality criteria, utilizing quality metrics.
# <b>Continuous Improvement</b>- With collaboration with stakeholders, the team will be able to identify areas for improvement and make important changes. The project team will use the feedback from quality audits and quality metrics to continually enhance the product and the quality processes. 
# <b>Reviewing Customer Feedback </b>- Customer feedback will be evaluated on a regular basis by the project team to find any issues or opportunities for improvement. To make sure that the product meets and exceeds customer expectations, this feedback will be used to guide ongoing improvement efforts. </p>

===Quality Control===
<p> The process of quality control within the Villamin Wood and Iron Works System project will be established into the Agile approach with the goal of ensuring that quality meets expectations through teamwork and continuous development. These are the following steps that involve in the project: </p>

#<b>Continuous Testing and Feedback </b>- To identify any issues and assure that the product corresponds to the demands of the client, the project team is going to perform a continual evaluation.
# <b>User Acceptance Testing </b>- To ensure that it aligns with client requirements and demands, the system's functionality will be monitored by the project manager or developer. This phase will be finished at the end of each sprint, and user feedback will be used to make any necessary improvements.
# <b>Capability Testing: </b> The Villamin Wood and Iron Works System will undergo testing across several phases, including mobile devices and any browser, to confirm consistency and handle any potential problems within the system.
...
; <i>1.3 Development, Testing, and Deployment</i>
...
# <b>Budget constraint </b>- The project was given with a limited financial resource by the client. This requires careful budget planning and cost optimization strategies to ensure procurement objectives are met within the allocated budget.
...
# <b>Contract Initiation</b>- The procurement process will be initiated by the project manager by sending a Workday request for procurement to the procurement officer.
# <b>Contract Planning </b>- A procurement plan that specifies the kind of contract to be used, the evaluation standards, and the deadlines for procurement activities will be created by the procurement officer.
# <b>Contract Development </b>- The procurement officer will create the contract documents, such as the Terms and conditions, a pricing schedule, and a Statement of Work (SOW) after the procurement plan has been approved.
# <b>Contract Review </b>- The legal department will examine the contract documents to make sure they adhere to all relevant laws and rules.
# <b>Contract Approval </b>- The Contract Review Committee will be asked to approve the contract documents. The Committee will then assess the contract documentation and provide the Project Manager with a recommendation.
# <b>Contract Execution </b>- The Procurement Officer will execute the contract and issue a purchase order during the Workday after it has been approved. 
# <b>Contract Monitoring </b>- To make sure the vendor is observing the terms of the contract, the project manager will monitor their performance. Additionally, the procurement officer will keep an eye on the agreement to make sure that all deliverables are fulfilled, and payments are made in accordance with the contract's terms.
...
# <b> Changes in Technology </b>- There is a risk that a change in the industry of technology occurs which may require additional work or resources to adapt.
# <b> Human Error </b>- There is risk that a person may commit a mistake or error that could negatively affect the project.
# <b> Unforeseen Circumstances </b>- There is a risk that circumstances such as natural disasters could cause disturbance and impact the project in an unexpected way.

<p> To mitigate these risks, the team has developed a plan which will mitigate all risks and monitor them all in the process to protect the project avoid all risks. </p>

==Risk Monitoring==
<p> Risks will always be present especially during the project’s life cycle which is why it is important to continuously monitor those risks and document the entire process which includes identifying the conditions which may trigger certain risks. </p>

<p> As for the plan, the project manager will incorporate and assign a risk manager to oversee the monitoring process which will help the team to determine if the risks require a higher level of attention in case the risks trigger. The risk manager will provide report updates during team meetings to keep everyone updated. </p>

<p> Furthermore, it should be noted that not only the risk manager should pay attention to any risks around the project, but the entire project team should also remain aware of the identified risks and the potential they have to impact the project which is why everyone is encouraged to help and notify the project manager or risk manager in case new risks occur. </p>

==Risk Mitigation and Avoidance==
<p> The risk management plan will be created by the team based on the criteria created rating the risks based on their impact and importance. In preparation for those risks, the project team will work alongside with stakeholders to put mitigation techniques in place to mitigate the risks. </p>

<p>To accomplish risk mitigation and avoidance the team should identify the potential risks and prioritize what to handle first based on the severity of its impact. Provided below are considerations or options available for the project manager to avoid and mitigate the risks:</p>

# <b>Resource Allocation </b>- Guaranteeing that the project has all the required resources is crucial for the project to be successful and efficient which is why resource allocation is important to ensure that the resources are available to the team to finish the project.
# <b>Risk Assessment </b>- The team needs to analyze potential risks effectively to anticipate it and immediately apply resolutions.
# <b>Contingency Planning </b>- To be prepared for potential risks, the team needs to produce multiple backup plans in case some may not work due to some reason in each scenario.
# <b>Contingency Planning </b>- To be prepared for potential risks, the team needs to produce multiple backup plans in case some may not work due to some reason in each scenario.
# <b>Communication </b>- It is important for the entire team to be able to communicate clearly and prevent misunderstandings as it has the potential to create risks. Having clear communication between the project team, clients, and stakeholders can help minimize these risks.
...
# <b>Knowledge Transfer</b> – A variety of approaches, including documentation and hands-on demonstrations, will be used to facilitate knowledge transfer. These initiatives seek to provide Villamin Wood and Iron Works with the skills and knowledge they need to provide effective system support.
...
# <b>Project Stakeholder </b>- responsible for allocating the required resources to guarantee the success of the project. Assuming responsibility for the relevant tasks and objectives. Staying updated on the project's advancements and sharing relevant information with the necessary individuals. Taking proactive steps to identify and fulfill training and development needs.
...
# <b>Project Team </b>- responsible for all deliverables such as documentation, planning, and implementing project schedules.
